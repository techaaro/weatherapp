...
export const weatherForecastData = async (data, key) => {
  ...
  if (data.lat && data.lon) {
    API_URL = `https://api.openweathermap.org/data/2.5/forecast?lat=${data.lat}&lon=${data.lon}&appid=958b8801b4d8d2abbbfd10df20d799f7&units=metric`;
  } else {
    API_URL = `https://api.openweathermap.org/data/2.5/forecast?q=${data}&appid=958b8801b4d8d2abbbfd10df20d799f7&units=metric`;
  }
